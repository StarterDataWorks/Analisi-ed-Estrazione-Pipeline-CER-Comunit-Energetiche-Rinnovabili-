Progetto di analisi esplorativa e modellazione dati sull'elenco nazionale delle CER pubblicato dal GSE.

Nota di progetto: Questo repository contiene l'Analisi Esplorativa (EDA) e le visualizzazioni interattive originali in Python. La pipeline di dati è stata successivamente convertita e integrata come pipeline SQL nel repository di [DataCivicLab] https://github.com/dataciviclab/dataset-incubator/tree/candidate/gse-cer-elenco/candidates/gse-cer-elenco
